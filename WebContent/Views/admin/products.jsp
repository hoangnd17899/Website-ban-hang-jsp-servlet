			  ...
			  <tbody>
			    <c:forEach items="${allproduct }" var="pro">
					<tr>
				      ...
				      <td><img style="height: 80px; width: 80px" src="Contents/Image/Product/${pro.image }" /></td>
				      <td>${pro.price }</td>
				      <td>${pro.origin }</td>
				      <td><a href="UpdateProductForward?id=${pro.productID }">Edit</a> | <a href="DeleteProductForward?id=${pro.productID }">Delete</a></td>
				    </tr>
				</c:forEach>
			  </tbody>
			</table>
